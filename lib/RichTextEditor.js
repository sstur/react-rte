  ...
  _createClass(RichTextEditor, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          otherProps = _objectWithoutProperties(_props, ['value', 'className', 'toolbarClassName', 'editorClassName', 'placeholder', 'customStyleMap', 'readOnly', 'disabled', 'toolbarConfig', 'blockStyleFn', 'rootStyle', 'toolbarStyle', 'editorStyle']);
