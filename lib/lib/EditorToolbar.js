  ...
  (0, _createClass3.default)(EditorToolbar, [{
    ...
    value: function _setCustomControlState(key, value) {
      this.setState(function (_ref) {
        ...
        return {
          customControlState: (0, _extends4.default)({}, customControlState, (0, _defineProperty3.default)({}, key, value))
        };
      });
    }
  }, {
    ...
    value: function _renderBlockTypeDropdown(name, toolbarConfig) {
      ...
      return _react2.default.createElement(
        ...
        { key: name },
        _react2.default.createElement(_Dropdown2.default, (0, _extends4.default)({}, toolbarConfig.extraProps, {
          choices: choices,
    ...
    value: function _renderBlockTypeButtons(name, toolbarConfig) {
      ...
      var buttons = (toolbarConfig.BLOCK_TYPE_BUTTONS || []).map(function (type, index) {
        return _react2.default.createElement(_StyleButton2.default, (0, _extends4.default)({}, toolbarConfig.extraProps, {
          key: String(index),
    ...
    value: function _renderLinkButtons(name, toolbarConfig) {
      ...
      var data = {};
      if (entity) {
        var _ref2 = entity != null && entity.type === _draftJsUtils.ENTITY_TYPE.LINK ? entity.getData() : null,
            url = _ref2.url;
    ...
    value: function _setLink(url) {
      ...
      var contentState = editorState.getCurrentContent();
      var selection = editorState.getSelection();
      contentState = contentState.createEntity(_draftJsUtils.ENTITY_TYPE.LINK, 'MUTABLE', { url: url });
      var entityKey = contentState.getLastCreatedEntityKey();
      var newEditorState = _draftJs.EditorState.push(editorState, contentState);
      this.setState({ showLinkInput: false });
      this.props.onChange(_draftJs.RichUtils.toggleLink(newEditorState, selection, entityKey));
      this._focusEditor();
    }
  }, {
    key: '_removeLink',
